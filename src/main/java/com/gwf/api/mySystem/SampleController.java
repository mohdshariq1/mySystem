...
//        //ResponseEntity<String> response1 = restTemplate.getForEntity("http://localhost:3380/hello", String.class);
//        //System.out.println(".......2" + response1.toString());
//        
//       // ResponseEntity<String> respons0 = restTemplate.getForEntity("http://localhost:3380/chaining", String.class);
...
//    
	...
	public ResponseEntity<String> persistPerson(@RequestBody PersonDTO person) {
		if (personService.isValid(person)) {
			...
			restTemplate.setMessageConverters(list);
			System.out.println(".......6");
			ResponseEntity<PersonDTO> response = restTemplate.postForEntity("http://localhost:8040/createPerson",
					userModel, PersonDTO.class);
			System.out.println(response.getBody());
			System.out.println(".......7");
   ...
   //     restTemplate.setMessageConverters(Arrays.asList(new MappingJackson2HttpMessageConverter()));
        ResponseEntity<Boolean> response = restTemplate.postForEntity("http://localhost:8040/availability",
